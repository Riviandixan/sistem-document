...
<div class="container">
    <div class="row justify-center">
        @approver
        <p class="text-start">
            <a href="{{ route('documents.remark-list') }}" class="btn btn-default">Remark Document</a>
        </p>
        @endapprover
        ...
        @maker
        <p class="text-end">
            <a href="{{ route('document.create') }}" class="btn btn-primary mb-2" style="width: 100%;">Create
                Document</a>
        </p>
        @endmaker
        @endif
        ...
        <div class="mt-2">
            <div class="card" style="width: 100%">
                <div class="card-body">
                    <h5 class="card-title">{{ $document->document_no }}
                        <div id="status"
                            class="badge @approver bg-secondary @endapprover @maker @if($document->status == 'approve' || $document->status == 'on progress') bg-success @elseif($document->status == 'reject') bg-danger @endif @endmaker float-end text-capitalize">
                            @approver @if($document->status == 'on progress') Unremarked @endif @endapprover
                    ...
                    @maker
                        <div class="row float-end">
                            <div class="col-6">
                                <a href="{{ route('document.edit', $document->document_no) }}" class="btn btn-primary">Edit</a>
                            </div>
                            <div class="col-6">
